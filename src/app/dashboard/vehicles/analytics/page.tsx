...
import { VehicleDashboard } from '@/components/vehicles/vehicle-dashboard';
...
export default function VehicleAnalyticsPage() {
  ...
  const handleReportGenerate = (
    ...
    alert(
      `Report "${reportType}" in ${format.toUpperCase()} format is being generated. You'll receive a download link shortly.`
    );
  };
