...
import {
  ...
  CombinedStatus,
  type TicketStatus
} from '@/components/ui/status-pills';
...
export default function TicketsListPage() {
  const [tickets, setTickets] = useState<
    (ServiceTicket & { customer?: Customer })[]
  >([]);
  ...
  useEffect(() => {
    const load = async () => {
      ...
      const res = await serviceTicketsApi.listTickets({
        search,
      ...
      <PageContainer>
        <div className='flex flex-col gap-6'>
          ...
          <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
            <SectionHeader
              title='Job Cards'
              description={`${kpis.total} total job cards • ${kpis.open} open • ${kpis.overdue} overdue`}
            />
          ...
          <Card>
            <CardContent className='py-6'>
              ...
              <div className='relative mb-4'>
                ...
                <Input
                  placeholder='Search by job card number, customer, vehicle reg, or symptoms...'
                  value={search}
              ...
              {showFilters && (
                <div className='bg-muted/30 grid grid-cols-1 gap-4 rounded-lg p-4 sm:grid-cols-2 lg:grid-cols-4'>
              ...
              {selectedTickets.size > 0 && (
                <div className='mt-4 flex items-center gap-2 rounded-lg border border-blue-200 bg-blue-50 p-3 dark:border-blue-800 dark:bg-blue-950/20'>
                  <span className='text-sm font-medium'>
                    {selectedTickets.size} ticket
                    {selectedTickets.size > 1 ? 's' : ''} selected
                  </span>
                    ...
                    {loading ? (
                      ...
                      <tr>
                        ...
                        >
                          <div className='flex flex-col items-center gap-2'>
                            <IconTicket className='text-muted-foreground/50 h-8 w-8' />
                      ...
                      tickets.map((ticket) => {
                        ...
                        return (
                          <tr
                            key={ticket.id}
                            className='hover:bg-muted/50 group border-t transition-colors'
                          >
                            <td className='px-3 py-3'>
                              <Checkbox
                            ...
                            <td className='px-3 py-3'>
                              {ticket.priority ? (
                                <PriorityPill
                                  priority={ticket.priority as 1 | 2 | 3}
                                  variant='compact'
                                />
                              ) : (
                            ...
                            <td className='px-3 py-3'>
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align='end'>
                                  ...
                                  <Link
                                      href={`/dashboard/job-cards/${ticket.id}`}
                                    >
              ...
              <Card>
                <CardContent className='p-8 text-center'>
                  <div className='flex flex-col items-center gap-3'>
                    <IconTicket className='text-muted-foreground/50 h-12 w-12' />
                      ...
                      <div className='space-y-3'>
                        ...
                        <div className='flex items-center justify-between border-t pt-2'>
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align='end'>
                              <DropdownMenuItem asChild>
                              <Link href={`/dashboard/job-cards/${ticket.id}`}>
                                  <IconEye className='mr-2 h-4 w-4' />
                                  View Details
                                </Link>
                              </DropdownMenuItem>
