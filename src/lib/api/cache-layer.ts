...
export class CachedKpiService {
  ...
  async fetchBatterySummaries(
    ...
    const ttl = params.offset
      ? CACHE_CONFIG.BATTERY_SUMMARIES.ttl / 2
      : CACHE_CONFIG.BATTERY_SUMMARIES.ttl;
    ...
    return cache(
      ...
      [cacheKey],
      {
        revalidate: ttl,
        tags: [
          ...CACHE_CONFIG.BATTERY_SUMMARIES.tags,
...
export class CachePerformanceMonitor {
  ...
  static logStats() {
    ...
    console.log(
      `Cache Performance - Hits: ${stats.hits}, Misses: ${stats.misses}, Hit Rate: ${stats.hitRate}%`
    );
  }
}
