...
export async function testDatabaseConnection() {
  try {
    ...
    console.log('✅ Customers table exists:', customers?.length, 'records found');
    ...
    console.log('✅ Battery_records table exists:', batteries?.length, 'records found');
    ...
    if (diagnosticsError) {
      console.error('❌ Technical_diagnostics table error:', diagnosticsError.message);
      return false;
    }
    
    console.log('✅ Technical_diagnostics table exists:', diagnostics?.length, 'records found');
    ...
    if (historyError) {
      console.error('❌ Battery_status_history table error:', historyError.message);
      return false;
    }
    
    console.log('✅ Battery_status_history table exists:', history?.length, 'records found');
