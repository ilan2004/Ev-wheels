...
import { CreatePaymentFormData, createPaymentSchema } from '@/lib/billing/schemas';
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
              ...
              <div className="grid gap-4 p-4 bg-muted/50 rounded-lg">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-green-600">{formatCurrency(watchedAmount || 0)}</span>
                </div>
                <div className="flex justify-between items-center border-t pt-2">
                  <span className="text-sm font-medium">Remaining Balance:</span>
                  <span className={cn(
                    "font-medium",
                    (balanceDue - (watchedAmount || 0)) > 0 ? "text-orange-600" : "text-green-600"
                  )}>
