...
> = {
  ...
  triaged: {
    label: 'Triaged',
    className:
      'bg-indigo-100 text-indigo-700 border-indigo-300 dark:bg-indigo-900/30 dark:text-indigo-300 dark:border-indigo-600',
  ...
  delivered: {
    label: 'Delivered',
    className:
      'bg-teal-100 text-teal-700 border-teal-300 dark:bg-teal-900/30 dark:text-teal-300 dark:border-teal-600',
  ...
  cancelled: {
    label: 'Cancelled',
    className:
      'bg-red-100 text-red-700 border-red-300 dark:bg-red-900/30 dark:text-red-300 dark:border-red-600',
  ...
  return (
    ...
    >
      <div className='relative flex h-6 w-6 items-center justify-center'>
        <span
          className={cn(
            'border-background h-3 w-3 rounded-full border-2',
            config.dot,
            isActive && 'ring-opacity-20 ring-2 ring-current'
          )}
        />
      </div>
...
export function StatusFilter({
  ...
  return (
    <select
      ...
      className={cn(
        'border-input inline-flex h-9 items-center justify-between rounded-md border bg-transparent px-3 py-2 text-sm shadow-sm',
...
export function getStatusGroup(
  status: TicketStatus
): keyof typeof STATUS_GROUPS | 'unknown' {
